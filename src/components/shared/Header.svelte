<script lang="ts">
	...
	let projectsButton: HTMLAnchorElement;
	let contactButton: HTMLAnchorElement;
	let underlineWidth: number;
	let underlineOffset: number;

	function getUnderlineStyle(pathname: string) {
		if (pathname === '/') {
			underlineWidth = homeButton?.clientWidth;
			underlineOffset = homeButton?.offsetLeft;
		}

		if (pathname === '/projects') {
			underlineWidth = projectsButton?.clientWidth;
			underlineOffset = projectsButton?.offsetLeft;
		}

		if (pathname === '/contact') {
			underlineWidth = contactButton?.clientWidth;
			underlineOffset = contactButton?.offsetLeft;
		}
	}

	function moveUnderline() {
		getUnderlineStyle($page.url.pathname);
	}
...
<header>
	<div class="inner-wrapper">
		<div class="navbar">
			...
			<nav>
				<div class="navLinks">
					<a href="/" class:active={$page.url.pathname === '/'} bind:this={homeButton}>Home</a>

					<a
						href="/projects"
						class:active={$page.url.pathname === '/projects'}
						bind:this={projectsButton}>Projects</a
					>
